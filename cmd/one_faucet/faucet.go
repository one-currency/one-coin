...
import (
	...
	"github.com/one-currency/one-coin/ethstats"
	"github.com/one-currency/one-coin/les"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/one-currency/one-coin/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
