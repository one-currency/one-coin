...
//
// https://github.com/one-currency/one-coin/wiki/Management-APIs#personal_sign
...
//
// https://github.com/one-currency/one-coin/wiki/Management-APIs#personal_ecRecover
