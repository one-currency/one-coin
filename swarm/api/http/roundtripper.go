...
see https://github.com/one-currency/one-coin/issues/2040
Usage:

import (
 "github.com/one-currency/one-coin/common/httpclient"
 "github.com/one-currency/one-coin/swarm/api/http"
)
